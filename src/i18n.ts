...
const resources = {
  he: {
    translation: {
      ...
      heroDesc: 'כאן תמצאו מנות סיניות מסורתיות ואהובות, המוכנות מדי יום עם החומרים הטריים והאיכותיים ביותר. אנחנו מביאים את הניחוחות של המטבח הסיני הביתי היישר לשולחן שלכם, תוך תשומת לב לכל פרט וטעם',
      orderNow: 'הזמן עכשיו',
      viewMenu: 'צפה בתפריט',
      whyUs: 'למה לבחור בנו?',
      whyDesc: 'אוכל סיני אותנטי המוכן טרי לפי הזמנה. מעדיפים להזמין יום מראש',
      fresh: 'אוכל טרי',
      freshDesc: 'כל מנה מוכנה טרי לפי הזמנה',
      authentic: 'אותנטי',
      authenticDesc: 'מתכונים מסורתיים שמועברים דור דור',
      delivery: 'משלוחים',
      deliveryDesc: 'משלוחים לירושלים והסביבה',
      testimonials: 'ביקורת לקוחות',
      testimonialsDesc: 'מה הלקוחות שלנו אומרים עלינו',
      rating: '5.0 מתוך 6 ביקורות',
      readyTaste: 'מוכנים לטעום את הטוב ביותר?',
      readyDesc: 'הזמינו עכשיו ותהנו מאוכל סיני אותנטי שמוכן טרי במיוחד עבורכם',
      fullMenu: 'צפה בתפריט המלא',
      contactUs: 'צרו קשר',
      name: 'שם',
      email: 'אימייל',
      message: 'הודעה',
      ...
      missingDelivery: 'חסרים {{amount}} ₪ למשלוח חינם!',
      couponError: 'קופון לא תקין',
